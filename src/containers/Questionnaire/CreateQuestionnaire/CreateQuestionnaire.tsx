...
import { EQuestionnaireType, ICreateQuestionnaireProps } from './CreateQuestionnaire.interface.ts';
import { buildCreateSurveyGqlVarsFromProps } from './CreateQuestionnaire.aux.ts';

export default function CreateQuestionnaire() {
	const theme = useMantineTheme();
	const form = useForm<ICreateQuestionnaireProps>({
		mode: 'controlled',
		initialValues: {
			type: null,
			title: '',
	...
	const handleQuestionnaireCreation = async (props: ICreateQuestionnaireProps) => {
